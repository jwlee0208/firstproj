...
public class ParseStringUtil {
     ...
     */
    public static HashMap<String,String> convertToStringToHashMap(String source) throws Exception {
    ...
    public static String convertToHashMaptoQueryString( HashMap<String, String> params ) throws Exception {
    ...
    public static String convertToHashMaptoQueryString( HashMap<String, Object> params, String get ) throws Exception {
    ...
    public static String[] convertToStringtoHashMap( String source, String separator )  throws Exception {
