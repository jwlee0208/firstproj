...
<script type="text/javascript" 		src="${pageContext.request.contextPath}/js/angular/test/test09.js"></script>
<head>
    <meta charset="utf-8">
			...
			<section ng-init="tab = 1" ng-controller="PanelController as panel">
				...
				<div class="panel" ng-show="panel.isSelected(3)">
					...
					<form name="reviewForm" ng-controller="ReviewController as reviewCtrl" ng-submit="reviewCtrl.addReview(product)">
						...
						<fieldset class="form-group">
							<textarea class="form-control" placeholder="리뷰를 입력해 주세요." title="Review" ng-model="reviewCtrl.review.comment"></textarea>
						</fieldset>
						<fieldset class="form-group">
							<input type="email" class="form-control" placeholder="이메일을 입력해 주세요." ng-model="reviewCtrl.review.author"/>
						</fieldset>				
						<fieldset class="form-group">
