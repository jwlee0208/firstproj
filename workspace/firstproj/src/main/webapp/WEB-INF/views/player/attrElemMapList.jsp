				...
				if(data != null){
					...
					if(attrElementList != null){
						...
						for(var i = 0 ; i < attrElementListLength ; i++){
							...
							innerHtml += "<span><input type=\"checkbox\" id=\"attrElem_" + attrElementList[i].attrElemId +"\" " + " name=\"" + attrElementList[i].attrElemId + "\" class=\"attrElemChkBox\" value=\"" + attrElementList[i].attrElemId + "\"/>" + attrElementList[i].attrElemName + "</span>";
...
<!-- 첫번째 카테고리 -->
<select id="cat1" name="cat1" onchange="javascript:setChildCategory();">
...
<!-- 두번째 카테고리 -->
<select id="cat2" name="cat2" onchange="javascript:setAttrList();">
	<option value="-1">카테고리를 선택해 주세요.</option>
</select>
<!--속성 & 속성 항목들에 대한 체크박스 리스트 -->
<div id="attrElemList"></div>

	<!-- <span id="secondCatSelectBox"></span> -->
