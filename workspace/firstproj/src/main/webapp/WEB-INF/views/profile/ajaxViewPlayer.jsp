...
<%@ taglib uri="http://www.springframework.org/tags" 	prefix="tag"%>
	...
	<div class="row">
		<ul class="nav nav-pills nav-fill" id="profileTab">
		  <li class="nav-item">
		    <a class="nav-link active" data-toggle="pill" href="#playerInfo">Player Information</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" data-toggle="pill" href="#playerAttribute">Player Attribute</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" data-toggle="pill" href="#career">Career</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" data-toggle="pill" href="#streamList">Play Streamming</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" data-toggle="pill" href="#statistic">Statistics</a>
		  </li>
		  <li class="nav-item">
