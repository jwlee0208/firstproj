$(document).on("ready", function() {
	$("input[name='goToWrite']").on("click", function() {
		location.href = "/prohibite/write.page?boardCategory="+$("#boardCategory").val();
	});
});
// 페이지 이동
...
function goView(boardId){
	...
	$("#selectedProhibitedWordId").val(boardId);
	
	var frm = $("#boardFrm");
	frm.attr("action", "/prohibite/view.page");
